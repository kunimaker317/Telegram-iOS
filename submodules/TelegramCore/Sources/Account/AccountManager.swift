...
private var declaredEncodables: Void = {
    ...
    // AyuGram attributes
    declareEncodable(AyuSoftDeletedMessageAttribute.self, f: { AyuSoftDeletedMessageAttribute(decoder: $0) })
    declareEncodable(AyuMessageEditEntry.self, f: { AyuMessageEditEntry(decoder: $0) })
    declareEncodable(AyuMessageEditHistoryAttribute.self, f: { AyuMessageEditHistoryAttribute(decoder: $0) })
